  ...
  var module = angular
    ...
    .factory('RzSliderOptions', function() {
      var defaultOptions = {
        ...
        showLabelOnSliders: true,
        useLegendAsLabels: false
      }
      var globalOptions = {}
    ...
    .factory('RzSlider', function(
      ...
      Slider.prototype = {
        ...
        getStepLegend: function(sliderValue) {
          var step = this.options.stepsArray[sliderValue]
          if (angular.isDate(step)) return step
       ...
       */
        ...
        updateFloorLab: function() {
          ...
          if(this.options.useLegendAsLabels) {
            this.translateFn(this.getStepLegend(this.lowValue), this.flrLab, 'floor', false)
          } else {
        ...
        updateCeilLab: function() {
          ...
          if(this.options.useLegendAsLabels) {
            this.translateFn(this.getStepLegend(this.highValue), this.ceilLab, 'ceil', false)
          } else {
        ...
        updateLowHandle: function(newPos) {
          ...
          if(this.options.showLabelOnSliders) {
            this.translateFn(this.lowValue, this.minLab, 'model')
          }

          if(this.lowValue === this.minValue) {
            this.minH.addClass('inactive');
          } else {
            this.minH.removeClass('inactive');
          }
        ...
        updateHighHandle: function(newPos) {
          ...
          if(this.options.showLabelOnSliders) {
            this.translateFn(this.highValue, this.minLab, 'high')
          }

          if(this.highValue === this.maxValue) {
            this.maxH.addClass('inactive');
          } else {
            this.maxH.removeClass('inactive');
          }
        ...
        updateSelectionBar: function() {
          ...
          if(this.lowValue > this.minValue || this.highValue < this.maxValue) {
            this.selBar.addClass('active');
          } else {
            this.selBar.removeClass('active');
          }
        ...
        callOnChange: function() {
          this.scope.$emit('minHandleMoved', this.minH);
          if(this.options.useLegendAsLabels){
            this.updateFloorLab();
            this.updateCeilLab();
          }
    ...
    .directive('rzslider', function(RzSlider) {
      ...
      return {
        ...
        templateUrl: function(elem, attrs) {
          ...
          return attrs.rzSliderTplUrl || '/assets/js/version3-mvc/angular/templates/plugins/rzSliderTpl.html'
        },
